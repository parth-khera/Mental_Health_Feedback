...
const features = [
  {
    ...
    desc: 'Your personal information and session details are fully protected and never shared with third parties.',
    icon: (
  ...
  },
  {
    ...
    desc: 'Our licensed professionals specialise in a wide range of mental health and medical therapy services.',
    icon: (
      <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
  ...
  {
    title: 'Holistic Care',
    desc: 'We address physical, emotional, and psychological wellbeing through personalised therapy plans.',
    icon: (
      <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
  ...
  {
    title: 'Drives Better Care',
    desc: 'Your feedback directly helps Klinixy improve therapy quality and patient outcomes for everyone.',
    icon: (
      <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
...
const steps = [
  { n: '01', title: 'Rate your session', desc: 'Choose a 1–5 star rating that reflects your therapy experience with Klinixy.' },
  { n: '02', title: 'Share your thoughts', desc: 'Tell us what worked, what could improve, and how your therapist made you feel.' },
  { n: '03', title: 'Submit securely', desc: 'Your feedback is sent securely and reviewed only by authorised Klinixy staff.' },
]
...
export default function HomePage() {
  return (
    <div className="overflow-x-hidden">
      ...
      <section className="relative min-h-screen flex items-center justify-center pt-16">
        ...
        <div className="relative max-w-4xl mx-auto px-6 text-center space-y-8">
          ...
          <div className="animate-in inline-flex items-center gap-2 px-4 py-2 rounded-full
            ...
            Klinixy — Your healing, our mission
          </div>
          ...
          <div className="animate-in animate-in-delay-1 space-y-3">
            <h1 className="text-[clamp(2.5rem,6vw,4.5rem)] font-semibold text-gray-900 leading-[1.1] tracking-tight">
              How was your<br />
              <span className="text-gradient">Klinixy therapy session?</span>
            </h1>
            <p className="text-[clamp(1rem,2vw,1.2rem)] text-gray-500 max-w-lg mx-auto leading-relaxed font-light">
              Share your experience with our therapists. Your honest feedback helps Klinixy
              deliver better, more personalised medical therapy care.
            </p>
          </div>
          ...
          <div className="animate-in animate-in-delay-3 flex flex-wrap justify-center gap-x-6 gap-y-2 pt-2">
            {['Secure & Confidential', 'Takes 2 minutes', 'Reviewed by Klinixy staff'].map(t => (
            ...
            <div className="bg-white/90 backdrop-blur-md rounded-3xl border border-white/80
              ...
              <div className="flex items-center justify-between">
                <div className="flex gap-1">
                  {[1,2,3,4,5].map(s => (
                    <svg key={s} viewBox="0 0 24 24" className="w-4 h-4" fill={s <= 5 ? '#22c55e' : '#e5e7eb'}>
                      <path d="M11.48 3.499a.562.562 0 011.04 0l2.125 5.111a.563.563 0 00.475.345l5.518.442c.499.04.701.663.321.988l-4.204 3.602a.563.563 0 00-.182.557l1.285 5.385a.562.562 0 01-.84.61l-4.725-2.885a.563.563 0 00-.586 0L6.982 20.54a.562.562 0 01-.84-.61l1.285-5.386a.562.562 0 00-.182-.557l-4.204-3.602a.563.563 0 01.321-.988l5.518-.442a.563.563 0 00.475-.345L11.48 3.5z" />
                    </svg>
                  ))}
                </div>
                <span className="badge bg-emerald-50 text-emerald-700 border border-emerald-100 text-[10px]">Excellent</span>
              </div>
              <p className="text-xs text-gray-600 leading-relaxed">
                "My therapist at Klinixy truly listened. I felt supported and understood throughout my entire treatment…"
              </p>
              <div className="flex items-center gap-2">
                ...
                <span className="text-[10px] text-gray-400">Klinixy Patient · just now</span>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* ── Services ── */}
      <section className="py-16 px-6 bg-sage-50/40">
        <div className="max-w-4xl mx-auto space-y-10">
          <div className="text-center space-y-3">
            <p className="text-xs font-semibold text-sage-500 uppercase tracking-widest">What We Offer</p>
            <h2 className="text-3xl md:text-4xl font-semibold text-gray-900 tracking-tight">Our therapy services</h2>
            <p className="text-gray-500 max-w-sm mx-auto">Klinixy provides a full spectrum of professional medical therapy services.</p>
          </div>
          <div className="flex flex-wrap justify-center gap-3">
            {services.map(s => (
              <span key={s} className="px-4 py-2 rounded-full bg-white border border-sage-200 text-sm text-sage-700 font-medium shadow-sm">
                {s}
              </span>
            ))}
          </div>
      ...
      <section id="how-it-works" className="py-24 px-6">
        <div className="max-w-4xl mx-auto space-y-16">
          <div className="text-center space-y-3">
            ...
            <p className="text-gray-500 max-w-sm mx-auto">Share your Klinixy experience in under two minutes.</p>
          </div>
      ...
      <section className="py-24 px-6 bg-gradient-to-b from-transparent to-sage-50/30">
        <div className="max-w-4xl mx-auto space-y-16">
          <div className="text-center space-y-3">
            <p className="text-xs font-semibold text-sage-500 uppercase tracking-widest">Why Klinixy</p>
            <h2 className="text-3xl md:text-4xl font-semibold text-gray-900 tracking-tight">Built on trust & care</h2>
            <p className="text-gray-500 max-w-sm mx-auto">Every aspect of Klinixy is designed around your wellbeing and comfort.</p>
          </div>
        ...
        <div className="max-w-2xl mx-auto">
          <div className="relative overflow-hidden rounded-4xl bg-gradient-to-br from-sage-500 to-sage-700
            ...
            <div className="relative space-y-6">
              ...
              <h2 className="text-3xl md:text-4xl font-semibold tracking-tight">Help us serve you better</h2>
              <p className="text-sage-100 max-w-sm mx-auto leading-relaxed">
                Your feedback helps Klinixy continuously improve the quality of care and therapy services for every patient.
              </p>
              <Link href="/feedback"
      ...
      <footer className="border-t border-gray-100 py-10 px-6">
        <div className="max-w-4xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm font-medium text-gray-700">Klinixy</span>
          </div>
          <p className="text-xs text-gray-400">© {new Date().getFullYear()} Klinixy · All feedback is confidential</p>
